...
Алгоритм слияния двух левосторонних приоритетных очередей без разрушения сначала сравнивает корневые элементы двух куч. 
Затем он рекурсивно сливает их правые поддеревья, делая большее значение корнем. 
После этого он проверяет, нужно ли поменять местами левое и правое поддеревья, чтобы сохранить левостороннее свойство кучи.

В случае слияния с разрушением алгоритм также сравнивает корневые элементы двух куч.
Однако здесь происходит обмен местами левого и правого поддеревьев без проверки и сохранения левостороннего свойства.
